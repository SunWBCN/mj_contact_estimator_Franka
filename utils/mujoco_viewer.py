...
class MujocoViewer(Callbacks):
    ...
    def _create_overlay(self, data=None):
    ...
    def visualize_mat_arrows(self, carry_mat_arrows):
        ...
        rgba = carry_mat_arrows.get("rgba", np.array([1.0, 0.0, 0.0, 1.0]))
    ...
    def visualize_normal_arrow(self, carry_normal_arrow):
        arrows_pos_world = carry_normal_arrow["arrows_pos_world"]
        arrows_vec_world = carry_normal_arrow["arrows_vec_world"]
        arrows_pos_ref_world = carry_normal_arrow.get("arrows_pos_ref_world", None)
        arrow_length = carry_normal_arrow.get("arrow_length", 0.4)
        rgba = carry_normal_arrow.get("rgba", np.array([0.0, 1.0, 0.0, 1.0]))
        ...
        for i in range(len(arrows_pos_world)):
            ...
            update_scene(self.scn, arrow_pos_world, arrow_mat_world)
    
    def visualize_particles(self, carry_particles):
        """
        ...
        def update():
            ...
            with self._gui_lock:
                ...
                if carry is not None:
                    if vis_arrows:
                        if "carry_mat_arrows" in carry.keys() and len(carry["carry_mat_arrows"].keys()) > 0:
                            self.visualize_mat_arrows(carry["carry_mat_arrows"])
                        if "carry_normal_arrows" in carry.keys() and len(carry["carry_normal_arrows"].keys()) > 0:
                            self.visualize_normal_arrow(carry["carry_normal_arrows"])
                    if vis_particles:
                        if "carry_particles" in carry.keys() and len(carry["carry_particles"].keys()) > 0:
                            self.visualize_particles(carry["carry_particles"])
